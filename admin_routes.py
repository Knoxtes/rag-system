...
def gdrive_authorize():
    ...
    try:
        # Get the redirect URI from environment or use production default
        gdrive_redirect_uri = os.getenv('GDRIVE_REDIRECT_URI', 'https://ask.7mountainsmedia.com/admin/gdrive/callback')
